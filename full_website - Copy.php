...
if(isset($_POST['login'])){
       ...
       // print_r($_POST);
        ...
        // $emsg='';
            ...
            $_SESSION['full_name']=$what[0]['name'];
...
<button class="navbar-toggler bg-danger border border-light" type="button" data-toggle="collapse" data-target="#navbar-list-4" aria-controls="navbarNav" aria-expanded="false" aria-label="Toggle navigation">
  <span class="navbar-toggler-icon text-dark"></span>
    ...
    <div class="collapse navbar-collapse " id="navbar-list-4">
              <ul class="navbar-nav flex mx-5 ms-auto">
                <li class="nav-item">
              ...
              <li class="nav-item dropdown ">
                  ...
                  <div class="dropdown-menu login-dropdown-123 text-dark" aria-labelledby="navbarDropdownMenuLink">
                    ...
                    <hr class="mt-1 mb-1">
                    <a class="dropdown-item flex-for-login-page text-dark" href="http://localhost/backend/full_website_by_suvo/cookie_array_result.php" target="_blank">View Appointment <i class="mx-2 fa-solid fa-user-pen"></i></a>
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
      ...
      <div class="modal fade" id="login-model" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
            aria-hidden="true">
            <div class="modal-dialog  modal-dialog-centered" role="document">
                <div class="modal-content modal-content-login pl-4 pr-4">
                    <div class="modal-header pt-4 ">
                        ...
                        <button type="button" class="close border border-light bg-light" data-dismiss="modal" aria-label="Close" id="login-modal-cross-456">
                    ...
                    <div class="modal-body modal-body-login">
                        ...
                        <form action="" method="POST" id="login-satck">
                          ...
                          <p class="mt-3 text-danger text-center">Don't Have An Account? <a href="" class="fw-bolder" data-toggle="modal" data-target="#sign_up" id="sign-up2">Signup</a></p>
                    </div>
                    ...
                    <div class="container h-100 ">
                        <div class="row d-flex  align-items-center h-100">
                            <div class="card-margin col-lg-12 col-xl-11 ">
                                ...
                                <div class="card-header mb-0 flex-end-2222" style="border-radius: 40px;">
                                    <button type="button" class="close border border-light bg-light" data-dismiss="modal" aria-label="Close" id="sign-up-close-101">
                                ...
                                <div class="card-body">
                                        <div class="row  justify-content-center"> 
                                            ...
                                            <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2" >
                                                ...
                                                <img src="sign_up.jfif" class="img-fluid" alt="Sample image" style="height:70vh;width:100%;">
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
<div class="modal fade" id="forget-password"  tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title text-primary" id="staticBackdropLabel">Reset Password</h5>
          <button type="button" class="btn-close" id="forget-password-close-btn" data-toggle="modal" data-target="#forget-password" aria-label="Close"></button>
        </div>
        <div class="modal-body">
          <form action="forgot_password.php" id="forget-password-form" method="POST">
            ...
            <div class="phone-verification center-column" id="phone-verification">
                    <p class="text-danger px-5">Enter your 10 digit phone number with country code. example: +91874*****10</p>
...
<section >
    ...
    <section class="search-sec  container">
        ...
        <form action="http://localhost/backend/full_website_by_suvo/slot_update2.php" method="post">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="row">
                            <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                                <input type="text" class="form-control search-slt" name="pin" placeholder="Enter Pin Code...">
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                                <input type="text" class="form-control search-slt" name="loca" placeholder="Enter Location\city...">
                            </div>
                            <div class="col-lg-3 col-md-3 col-sm-12 p-0">
                                <select class="form-control search-slt" id="exampleFormControlSelect1" name="cat">
                                    ...
                                    <option value="Cardiology">Cardiogy</option>
                                    <option value="Dermetology">Dermetology</option>
    ...
    <div class="container ">
        ...
        <div class="row flex   margin-up bg-light">
            <h2 class="flex mt-3">ABOUT  TECHcare</h2>
            <P class="w-75 flex">TECHcare is an online system that allows 
                            you to book appointments with doctors online.
                            You can book an appointment with a doctor of your choice without having to
                            go through the hassle of visiting their clinic.
                            TECHcare also enables you to check the doctor's 
                            availability and book an appointment accordingly.
                            You will be able to view the doctor's ratings and reviews
                            before making a decision. This will help you choose the
                            best doctor for your requirement.</P>
                ...
                <div class="p-2  flex-justify-spbt w-100">
                    <div class="card p-sm-3 ">
                        <div class="card card_r mt-sm-2" style="width: 15rem; ">
                            <div class="card-body">
                              <p class="card-text">Booking an Appoinment Within 2 minutes.<i class="fa-regular fa-calendar-check mx-3" style="font-size:35px;color:green;"></i></p>
                              
                            </div>
                          </div>
                          <div class="card card_r mt-sm-2" style="width: 15rem;">
                            <div class="card-body">
                              <p class="card-text">Quickly Cancel or Reschedule your appointment <i class="fa-regular fa-calendar-xmark mx-3" style="font-size:35px;color:red;"></i></p>
                            </div>
                          </div>
                    </div>
            ...
            <div class="col-12">
                <div class="row">
                    <div class="mx-auto col-7">
                        ...
                        <h6 class="flex">We Provide Different Specialities According To The Patient Needs.</h6>
                    </div>
                </div>
            </div>
            <div class="col-12 ">
...
<script>
    ...
    $(document).ready(function(){
         //-----------------------this is for newly edited for forgrt password-------------------------------------------------
        $("#but_forget").click(function(){
            window.location.href = "full_website - Copy.php?req=change_password&login=failed&t-t-t=yes"; 
            // actually we redirect main page with some value due to avoid an unexpected error.
        });
        <?php 
        if(count($x)==3){
        ?>
             $('#forget-password').modal('show'); // then we check the condition and show the modal when the condition is matched.
        <?php } ?>
        $('#forget-password-close-btn').click(function(){
            window.location.href = "full_website - Copy.php";
            // actually we redirect main page due to avoid an unexpected error.
        });
        //-----------------------this is for newly edited for forgrt password-------------------------------------------------

            $("#login-modal-cross-456").click(function(){
            $('#login-model').modal('hide');
        });

        $("#sign-up-close-101").click(function(){
            $('#sign_up').modal('hide');
        });
        // echo $ch
        $('#sign-up2').click(function(){
            $('#login-model').modal('hide');
        });
        <?php 
        if($ch==1){
