                                ...
                                <div class="col-6 bg-light p-3">
                                    ...
                                    <div class="row ">
                                        <div class="col-12  flex">
                                            ...
                                            <img src="dr-dr-sanjat-chiwane.jpg" class="img-fluid box img-thumbnail" alt="...">
                                        </div>
...
foreach ($dt as $date => $slt) {
    ...
    $t = $res1[$w];
    echo $date."($t):";
    $url = "http://localhost/subhankar/slot5.php?b_id=" . $id . "&slt=" . $date  . "&dpt=" . $dpt ."&fee=" . $fees. "&tm=" . $t . "&nm=" . $nm;
    ?>
